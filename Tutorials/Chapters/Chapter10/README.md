...
- **A suspiciously perfect result before any real training has happened is a signal to investigate, not celebrate**, verified directly, through a real mistake caught and corrected while building this very chapter.
- **LambdaMART's bottom-of-ranking weakness is a real, structural, mathematically-grounded property** of NDCG's discount curve, not a defect, consistent with what we found and verified when building this feature earlier.
