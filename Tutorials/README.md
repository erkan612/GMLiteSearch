...
- **A `TutorialChapterN.md` file**, the chapter itself, with explanations, diagrams, and complete code examples.
...
### [Chapter 1: What Is a Search Engine, Anyway?](TutorialChapter1.md)
...
### [Chapter 2: Documents, Metadata, and Why Structure Matters](TutorialChapter2.md)
...
### [Chapter 3: Typos, Prefixes, and Making Search Forgiving](TutorialChapter3.md)
...
### [Chapter 4: Filtering, Faceted Search Explained](TutorialChapter4.md)
...
### [Chapter 5: Working With Time, Date Facets and Time-Based Queries](TutorialChapter5.md)
...
### [Chapter 6: Location-Aware Search, Geospatial Concepts](TutorialChapter6.md)
...
### [Chapter 7: Making Results Readable, Snippets and Query Understanding](TutorialChapter7.md)
...
### [Chapter 8: Teaching the Machine, Introduction to Learning-to-Rank](TutorialChapter8.md)
...
### [Chapter 9: Beyond Regression, RankNet and Custom Signals](TutorialChapter9.md)
...
### [Chapter 10: Decision Trees, Boosting, and LambdaMART](TutorialChapter10.md)
...
Throughout this series, where I found a genuine limitation, an edge case, or a confirmed quirk in how GMLiteSearch actually behaves, I documented it directly rather than smoothing it over, a fixed date-bucketing scheme that isn't calendar-meaningful, a snippet highlighter that can silently skip a term in specific mixed-case situations, NDCG's inherent bias toward the top of a ranking. Understanding a tool's real edges, not just its happy path, is part of genuinely knowing how to use it well. None of these are reasons to avoid the affected features, they're context that makes you a more effective user of them.
